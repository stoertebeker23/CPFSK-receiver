...
\frame{
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      Vorgehen
      \begin{itemize}
        \item 1. In MATLAB Bandpass als FIR-Filter ausgelegt
        \item 2. Dezimationsfaktor bestimmt: $\frac{fA_{red}}{fA_{green}} \approx 527$
        \item 3. Polyphasen als \textit{const short} exportieren
        \item 4. ANSI-C Implementierung
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
        \begin{itemize}
